...
path='Countering_Hate_Speech_ICWSM2019/utils/'
...
def gen_data_new_tfidf(pd_train):
    ...
    if(path.exists(path+"tfidf_word_vectorizer.pk")):
            with open(path+'tfidf_word_vectorizer.pk', 'rb') as fin:
    ...
    if(path.exists(path+"tfidf_char_vectorizer.pk")):
            with open(path+'tfidf_char_vectorizer.pk', 'rb') as fin:
            ...
            with open(path+'tfidf_char_vectorizer.pk', 'wb') as fin:
